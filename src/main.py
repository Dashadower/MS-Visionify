...
class MacroController:
    def __init__(self, keymap=km.DEFAULT_KEY_MAP):
        ...
        self.rune_model_path = r"C:\Users\tttll\PycharmProjects\MacroSTory\src\arrow_classifier_keras_gray.h5"
    ...
    def loop(self):
        ...
        if rune_coords:
            ...
            if (time.time() - self.player_manager.last_rune_solve_time) >= self.player_manager.rune_cooldown:
